...
if (file_exists($configFile)) {
    ...
    // Fallback para gates padrão caso config.json não exista
    $gates = [
        [
            'id' => 1,
            'name' => 'PRE AUTH CC',
            'slug' => 'preauth',
            'icon' => 'fa-credit-card',
            'description' => 'Checker de cartões com pré-autorização. Validação rápida e eficiente.',
            'status' => 'active',
            'gateway' => 'pagseguro'
        ],
        [
            'id' => 2,
            'name' => 'ALL BINS GG VBV',
            'slug' => 'allbins',
            'icon' => 'fa-check-circle',
            'description' => 'Suporta todas as bandeiras de cartões. Gate otimizada para máxima aprovação.',
            'status' => 'active',
            'gateway' => 'pagseguro'
        ],
        [
            'id' => 3,
            'name' => 'Gerador de Cartões',
            'slug' => 'gerador',
            'icon' => 'fa-credit-card',
            'description' => 'Gere cartões de teste com BINs personalizados de forma rápida e prática.',
            'status' => 'active',
            'gateway' => 'gerador'
        ]
    ];
    ...
    <div class="container mt-4">
        ...
        <div class="header-section">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div>
                    <a href="admin_panel.php" class="logout-btn" style="background: linear-gradient(45deg, #FF9800, #F57C00); box-shadow: 0 4px 15px rgba(255, 152, 0, 0.4); margin-right: 10px;">
        ...
        <!-- Checker Options (Dinâmico) -->
        <div class="row">
            <?php foreach ($gates as $gate): ?>
                <div class="col-md-4 mb-3">
                    <?php if ($gate['status'] === 'active'): ?>
                        <?php if ($gate['slug'] === 'gerador'): ?>
                            <a href="gerador.php" class="checker-card">
                        <?php else: ?>
